...
**If you need any more modes in repo or If you find out any bugs, mention in [@codexbotzsupport ](https://www.telegram.dog/allbotscollections)**
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://github.com/Movieschannelofficials/File-Sharing-Bot)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/Movieschannelofficials/File-Sharing-Bot
cd File-Sharing-Bot
